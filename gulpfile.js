...
gulp.task('images', function () {
    return gulp.src(['!app/img/icons/**/*.*', '!app/img/sprite/*.*', 'app/img/*.*'])
    // корректная запись исключения, надо указывать именно 'любые файлы'.
    // Если исключать '!app/img/any_folder/*', то не скопирует файлы, но притащит пустую папку в dist
...
gulp.task('watch', ['browser-sync'], function() {
    gulp.watch(['app/sass/**/*.scss', 'app/blocks/**/*.scss'], ['sass']); // Наблюдение за sass файлами
    gulp.watch(['app/blocks/**/*.pug', 'app/pages/**/*.pug'], ['pug']); // Наблюдение за Pug файлами
